...
**Every knight starts as a squire.**

**Try Squire → Coming soon!**

Most opening trainers stop at openings. Most endgame content is a static
article or a handful of famous puzzles. Squire is built to actually close
the loop across all three phases of a game, and to do it properly rather
than superficially — the whole board, covered:

## Drill your repertoire, not just your memory

A spaced-repetition (SM-2) opening trainer, persisted to a real account
from day one — not a local flashcard deck that resets when you clear your
browser. Build a repertoire, save the lines you actually play, and let
the app tell you what's due today.
